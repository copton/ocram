...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <firmware EXPORT="copy">[CONFIG_DIR]/../setup/client.sky</firmware>
    ...
    <motetype>
      ...
      <description>app</description>
      <firmware EXPORT="copy">[CONFIG_DIR]/../setup/peer.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
  ...
  <plugin>
	...
	<plugin_config>
        ...
        <appstack size="152">stack_server</appstack>
        <appstack size="170">stack_worker0</appstack>
        <appstack size="170">stack_worker1</appstack>
        <appstack size="170">stack_worker2</appstack>
        <appstack size="170">stack_worker3</appstack>
	</plugin_config>
    <mote_arg>1</mote_arg>
    <width>207</width>
    <z>4</z>
